...
class GetTotalWishlistByIsAchieved extends StatefulWidget {
  const GetTotalWishlistByIsAchieved({Key key}) : super(key: key);

  @override
  State<GetTotalWishlistByIsAchieved> createState() =>
      _GetTotalWishlistByIsAchievedState();
}

class _GetTotalWishlistByIsAchievedState
    extends State<GetTotalWishlistByIsAchieved> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: FutureBuilder(
        future: apiService.getTotalWishlistByIsAchieved(),
  ...
  Widget _buildListView(List<PieData> contents) {
    return Container(
        ...
        child: getPieChart(chartData, 'Total Wishlist By Is Achieved'));
  }
}
