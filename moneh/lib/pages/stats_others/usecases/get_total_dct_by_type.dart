...
class GetTotalDctByType extends StatefulWidget {
  const GetTotalDctByType({Key key}) : super(key: key);

  @override
  State<GetTotalDctByType> createState() => _GetTotalDctByTypeState();
}

class _GetTotalDctByTypeState extends State<GetTotalDctByType> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: FutureBuilder(
        future: apiService.getTotalDctByType(),
  ...
  Widget _buildListView(List<PieData> contents) {
    return Container(
        ...
        child: getPieChart(chartData, 'Total Dictionary By Type'));
  }
}
